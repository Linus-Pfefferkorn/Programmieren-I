 ...
 */
public class Lager extends Arbeitsstelle {

	/**
	 * Ort, in dem das Lager platziert wird. Die Funktionalitaet ist nicht vom Ortsnamen abhaengig.
	 * Der Ort kann beliebig gewaehlt werden und dient lediglich der Illustration im Spiel. 
	 */
	//private String ort; --> bereits in Oberklasse vorhanden

	/**
	 * Erfassung der Warenarten im Lager und der jeweiligen Lagerbestaende. Wenn eine Warenart
	 * nicht im Lager vorhanden ist, wird sie auch in dieser HashMap nicht gefuehrt.
	 */
	 ...
	 */
	public Lager(String ort, int anzahlarbeiter) {
			super(ort, anzahlarbeiter);	// --> nur die in der Oberklasse definierten Attribute
	}

	/**
	 * Einlagern von Waren einer bestimmten Warenart mit einer bestimmten Menge. Mit dem Aufruf
	 * wird der Lagerbestand entsprechend erhoeht.
	...
	/**
	 * Verkaufen von Waren fuehrt zum Verringern von Warenbestand der genannten Warenart.
	 ...
	 * @return					Erloes in Taler, der durch den Verkauf zum genannten Preis erzielt wird 
	 */
